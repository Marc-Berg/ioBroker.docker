##### Note: This repository provides the current ioBroker Docker image for the secondary namespace.
...
ioBroker image based on Debian Trixie and Node.js 24. This project is based on the established ioBroker Docker image architecture. Thank you to Buanet and the previous contributors for the foundation and years of maintenance.
